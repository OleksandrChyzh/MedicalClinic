...
@Component({
  ...
  `,
  styles: [`.admin-page{display:flex;flex-direction:column;gap:20px;padding:0 1rem;max-width:1400px;width:100%;margin:0 auto;box-sizing:border-box;overflow-x:hidden}.page-header{display:flex;justify-content:space-between;align-items:flex-start;gap:16px}.eyebrow{color:#0284c7;font-weight:800;text-transform:uppercase;font-size:.78rem}h1,h2,h3{margin:0;color:#0f172a}.panel,.card{background:#fff;border:1px solid #e2e8f0;border-radius:18px;padding:18px;box-shadow:0 10px 25px rgba(15,23,42,.05);box-sizing:border-box}.form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.wide{grid-column:1/-1}label{display:flex;flex-direction:column;gap:6px;font-weight:700;color:#334155}input,select,textarea{padding:10px 12px;border:1px solid #cbd5e1;border-radius:10px}textarea{min-height:80px}.primary{background:#0284c7;color:#fff;border:0;border-radius:10px;padding:10px 14px;font-weight:800;cursor:pointer}.ghost{background:#f8fafc;color:#334155;border:1px solid #cbd5e1;border-radius:10px;padding:10px 14px}.danger{background:#fee2e2;color:#b91c1c;border:0;border-radius:10px;padding:9px 12px}.actions{display:flex;gap:10px;justify-content:flex-end;flex-wrap:wrap}.grid-list{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:14px;width:100%;max-width:100%;min-width:0;padding-right:0;box-sizing:border-box}.card{display:flex;flex-direction:column;gap:10px;width:100%;max-width:100%;min-width:0}@media(max-width:760px){.form-grid{grid-template-columns:1fr}.page-header{flex-direction:column}.grid-list{grid-template-columns:1fr}}`]
})
